  ...
  return (
    ...
    <div className='flex flex-row float-right pr-24'>
            <div className='font-bold list-none flex flex-row flex-wrap text-lg py-2 justify-center float-right'>
                ...
                <li className='p-4 underline hover:underline-offset-8 font-Import2 decoration-black hover:decoration-white'> <a href="https://saiwebsiteskills.onrender.com">Skills</a></li>
                ...
                <li className='p-4 underline hover:underline-offset-8 font-Import2 decoration-black hover:decoration-white'> <a href="/">Connect</a></li>
            </div>
        </div>
        </div>
    </>
